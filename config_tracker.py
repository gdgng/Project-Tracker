...
class ConfigTracker(tk.Tk):
    ...
    def create_gui(self):
        ...
        self.notifications = tk.BooleanVar(value=self.config.getboolean("Miscellaneous", "Notifications", fallback=False))
        ...
        self.create_checkbox(misc_frame, "Notifications", self.notifications)
    ...
    def save_config(self):
        ...
        try:
            ...
            self.config["Miscellaneous"] = {
                ...
                "Notifications": str(self.notifications.get()),
